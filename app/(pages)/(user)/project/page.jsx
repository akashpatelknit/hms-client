...
const ProjectInfo = () => {
	return (
		<div className=" min-h-[70vh]">
			<Container>
				<h2 className="text-2xl font-semibold text-gray-900 sm:text-4xl text-center mt-10">
					Welcome to the Hostel Management System!
				</h2>
				<p className="mt-5 text-gray-600 text-md text-center w-[75%] m-auto">
				...
				<p className="mt-5 text-gray-600 text-md text-center w-[75%] m-auto">
					...
					through our notification panel, keeping residents informed
					and engaged. With our HMS, hostel life becomes more
					manageable, efficient, and enjoyable, offering a
					comprehensive solution to address all hostel-related needs
